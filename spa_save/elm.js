...
var author$project$Main$toModelCmdHelper = F4(
...
var author$project$Main$toSession = function (model) {
	switch (model.$) {
		...
		case 'Home':
			...
			return homeModel.session;
		default:
			var loginModel = model.a;
			return loginModel.session;
	}
};
...
var author$project$Main$toModelCmd = F2(
	function (maybeRoute, model) {
		...
		if (maybeRoute.$ === 'Nothing') {
			...
			if (maybeRoute.a.$ === 'Home') {
				...
				return A4(
					author$project$Main$toModelCmdHelper,
...
var author$project$Session$fromUser = F2(
	function (key, maybeUser) {
		if (maybeUser.$ === 'Just') {
			...
			return A2(author$project$Session$LoggedIn, key, user);
		} else {
...
var author$project$Main$init = F3(
	function (_n0, url, navKey) {
		return A2(
			author$project$Main$toModelCmd,
			author$project$Route$fromUrl(url),
			author$project$Main$Home(
				{
					session: A2(author$project$Session$fromUser, navKey, elm$core$Maybe$Nothing)
				}));
	});
				...
				default:
					if (_n0.b.$ === 'Login') {
						...
						return A4(
							...
							author$project$Main$LoginMsg,
							model,
							A2(author$project$Page$Login$update, loginMsg, loginModel));
					} else {
						break _n0$5;
					}
			}
...
var author$project$Page$Error$view = {
	content: A2(
...
var author$project$Page$Home$SignIn = {$: 'SignIn'};
var author$project$Page$Home$blue = A3(mdgriffith$elm_ui$Element$rgb255, 5, 71, 151);
var author$project$Page$Home$props = {borderRound: 5, buttonColor: author$project$Page$Home$blue};
var author$project$Page$Home$white = A3(mdgriffith$elm_ui$Element$rgb255, 255, 255, 255);
...
var author$project$Page$Home$viewSigninButton = A2(
	mdgriffith$elm_ui$Element$Input$button,
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$padding(17),
			mdgriffith$elm_ui$Element$centerX,
			mdgriffith$elm_ui$Element$Background$color(author$project$Page$Home$props.buttonColor),
			mdgriffith$elm_ui$Element$Border$rounded(author$project$Page$Home$props.borderRound)
		]),
	{
		label: A2(
			mdgriffith$elm_ui$Element$el,
		...
		onPress: elm$core$Maybe$Just(author$project$Page$Home$SignIn)
	});
var author$project$Page$Home$darkGray = A3(mdgriffith$elm_ui$Element$rgb255, 50, 50, 50);
...
var author$project$Page$Home$viewWelcome = A2(
	mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[mdgriffith$elm_ui$Element$centerX]),
	A2(
		...
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$Font$color(author$project$Page$Home$darkGray),
				mdgriffith$elm_ui$Element$Font$size(80),
	...
	return {
		content: A2(
			...
			A2(
				...
				_List_fromArray(
					[author$project$Page$Home$viewWelcome, author$project$Page$Home$viewSigninButton]))),
		title: 'Home'
	};
};
var author$project$Page$Login$blue = A3(mdgriffith$elm_ui$Element$rgb255, 5, 71, 151);
var author$project$Page$Login$props = {borderRound: 5, buttonColor: author$project$Page$Login$blue, elementSpacing: 20, formInputHeight: 50};
var author$project$Page$Login$EmailEntry = function (a) {
	return {$: 'EmailEntry', a: a};
};
var author$project$Page$Login$darkGray = A3(mdgriffith$elm_ui$Element$rgb255, 80, 80, 80);
var author$project$Page$Login$lightGray = A3(mdgriffith$elm_ui$Element$rgb255, 200, 200, 200);
...
var author$project$Page$Login$formInputAttrs = _List_fromArray(
	[
		mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
		mdgriffith$elm_ui$Element$height(
		mdgriffith$elm_ui$Element$px(author$project$Page$Login$props.formInputHeight)),
		mdgriffith$elm_ui$Element$Border$width(1),
		mdgriffith$elm_ui$Element$Border$rounded(author$project$Page$Login$props.borderRound),
		mdgriffith$elm_ui$Element$Border$color(author$project$Page$Login$lightGray),
		mdgriffith$elm_ui$Element$Font$color(author$project$Page$Login$darkGray)
	]);
...
var author$project$Page$Login$formPlaceholder = function (placeholder) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$Font$color(author$project$Page$Login$lightGray)
				]),
...
var author$project$Page$Login$viewEmailInput = function (email) {
	return A2(
		mdgriffith$elm_ui$Element$Input$email,
		author$project$Page$Login$formInputAttrs,
		{
			label: mdgriffith$elm_ui$Element$Input$labelHidden('Enter email'),
			onChange: author$project$Page$Login$EmailEntry,
			placeholder: elm$core$Maybe$Just(
				author$project$Page$Login$formPlaceholder('Email')),
			text: email
		});
};
var author$project$Page$Login$PasswordEntry = function (a) {
	return {$: 'PasswordEntry', a: a};
};
...
var author$project$Page$Login$viewPasswordInput = function (password) {
	return A2(
		mdgriffith$elm_ui$Element$Input$currentPassword,
		author$project$Page$Login$formInputAttrs,
		{
			label: mdgriffith$elm_ui$Element$Input$labelHidden('Enter email'),
			onChange: author$project$Page$Login$PasswordEntry,
			placeholder: elm$core$Maybe$Just(
				author$project$Page$Login$formPlaceholder('Password')),
			show: false,
			text: password
		});
};
var author$project$Page$Login$viewForm = function (form) {
	return A2(
		...
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
				mdgriffith$elm_ui$Element$spacing(author$project$Page$Login$props.elementSpacing)
			]),
		_List_fromArray(
			[
				author$project$Page$Login$viewEmailInput(form.email),
				author$project$Page$Login$viewPasswordInput(form.password)
			]));
};
var author$project$Page$Login$SubmitForm = function (a) {
	return {$: 'SubmitForm', a: a};
};
var author$project$Page$Login$white = A3(mdgriffith$elm_ui$Element$rgb255, 255, 255, 255);
var mdgriffith$elm_ui$Internal$Model$Right = {$: 'Right'};
var mdgriffith$elm_ui$Element$alignRight = mdgriffith$elm_ui$Internal$Model$AlignX(mdgriffith$elm_ui$Internal$Model$Right);
var author$project$Page$Login$viewFormSubmitButton = function (form) {
	return A2(
		mdgriffith$elm_ui$Element$Input$button,
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$Background$color(author$project$Page$Login$props.buttonColor),
				mdgriffith$elm_ui$Element$Border$rounded(author$project$Page$Login$props.borderRound)
			]),
		{
			label: A2(
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$centerX,
						mdgriffith$elm_ui$Element$centerY,
						mdgriffith$elm_ui$Element$Font$color(author$project$Page$Login$white)
					]),
				mdgriffith$elm_ui$Element$text('Sign in')),
			onPress: elm$core$Maybe$Just(
				author$project$Page$Login$SubmitForm(form))
		});
};
var author$project$Page$Login$view = function (model) {
	var viewValidate = A2(
		...
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$text('You\'ve entered: '),
				A2(
				mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[mdgriffith$elm_ui$Element$Font$bold]),
				mdgriffith$elm_ui$Element$text(model.form.email)),
				mdgriffith$elm_ui$Element$text(' and '),
				A2(
				mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[mdgriffith$elm_ui$Element$Font$bold]),
				mdgriffith$elm_ui$Element$text(model.form.password))
			]));
	return {
		content: A2(
			mdgriffith$elm_ui$Element$layout,
			...
			A2(
				...
				_List_fromArray(
					[
						...
						author$project$Page$Login$viewFormSubmitButton(model.form),
						viewValidate
					]))),
		title: 'Login'
	};
