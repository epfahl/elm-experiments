...
var author$project$Main$Form = F2(
...
var author$project$Main$init = F3(
	function (_n0, url, navKey) {
		return _Utils_Tuple2(
			{
				key: navKey,
				login: A2(author$project$Main$Form, '', ''),
...
var author$project$Main$update = F2(
	function (msg, model) {
		var _n0 = A2(
			elm$core$Debug$log,
			'update route: ',
			author$project$Main$routeToString(model.route));
		switch (msg.$) {
			case 'LinkClicked':
...
var author$project$Main$darkGray = A3(mdgriffith$elm_ui$Element$rgb255, 60, 60, 60);
...
var author$project$Main$viewError = function (_n0) {
	return A2(
			...
			_List_fromArray(
				[
					...
					A2(
						...
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$Font$color(author$project$Main$darkGray),
								mdgriffith$elm_ui$Element$Font$size(80),
								mdgriffith$elm_ui$Element$Font$bold
							]),
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$text('Invalid route!')
							])))
				])));
};
var author$project$Main$blue = A3(mdgriffith$elm_ui$Element$rgb255, 5, 71, 151);
...
var author$project$Main$viewHome = function (_n0) {
	return A2(
		mdgriffith$elm_ui$Element$layout,
		_List_Nil,
		A2(
				...
				[
						...
						]),
					{
						label: A2(
							...
							{
								label: mdgriffith$elm_ui$Element$text('Get started'),
								url: '/login'
							}),
...
var author$project$Main$EmailEntry = function (a) {
	return {$: 'EmailEntry', a: a};
};
var author$project$Main$PasswordEntry = function (a) {
...
var author$project$Main$formPlaceholder = function (placeholder) {
	return A2(
...
var author$project$Main$lightGray = A3(mdgriffith$elm_ui$Element$rgb255, 200, 200, 200);
...
var author$project$Main$viewLogin = function (_n0) {
	var login = _n0.login;
	var viewFormSubmitButton = A2(
		mdgriffith$elm_ui$Element$Input$button,
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$padding(17),
	...
	var attrs = _List_fromArray(
		[
			...
			mdgriffith$elm_ui$Element$Border$width(1),
			mdgriffith$elm_ui$Element$Border$rounded(5),
			mdgriffith$elm_ui$Element$Border$color(author$project$Main$lightGray),
			mdgriffith$elm_ui$Element$Font$color(author$project$Main$darkGray)
		]);
	var viewEmailInput = A2(
		mdgriffith$elm_ui$Element$Input$email,
		attrs,
		{
			label: mdgriffith$elm_ui$Element$Input$labelHidden('Enter email'),
			onChange: author$project$Main$EmailEntry,
			placeholder: elm$core$Maybe$Just(
				author$project$Main$formPlaceholder('Email')),
			text: login.email
		});
	var viewPasswordInput = A2(
		mdgriffith$elm_ui$Element$Input$currentPassword,
		attrs,
		{
			label: mdgriffith$elm_ui$Element$Input$labelHidden('Enter email'),
			onChange: author$project$Main$PasswordEntry,
			placeholder: elm$core$Maybe$Just(
				author$project$Main$formPlaceholder('Password')),
			show: false,
			text: login.password
		});
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[viewEmailInput, viewPasswordInput, viewFormSubmitButton])));
};
